...
if (PHP_MAJOR_VERSION == 5 && PHP_MINOR_VERSION < 5) {
    ...
    require_once dirname(__FILE__) . '/Api/ConfigurableField.php';
    require_once dirname(__FILE__) . '/Api/Coupon.php';
    require_once dirname(__FILE__) . '/Api/CustomField.php';
    require_once dirname(__FILE__) . '/Api/Customer.php';
    require_once dirname(__FILE__) . '/Api/DiscountRule.php';
    require_once dirname(__FILE__) . '/Api/Option.php';
    require_once dirname(__FILE__) . '/Api/OptionSet.php';
    require_once dirname(__FILE__) . '/Api/OptionSetOption.php';
    require_once dirname(__FILE__) . '/Api/OptionValue.php';
    require_once dirname(__FILE__) . '/Api/Order.php';
    require_once dirname(__FILE__) . '/Api/OrderProduct.php';
    require_once dirname(__FILE__) . '/Api/OrderStatus.php';
    require_once dirname(__FILE__) . '/Api/Product.php';
    require_once dirname(__FILE__) . '/Api/ProductImage.php';
    require_once dirname(__FILE__) . '/Api/ProductOption.php';
    require_once dirname(__FILE__) . '/Api/RequestLog.php';
    require_once dirname(__FILE__) . '/Api/Resource.php';
    require_once dirname(__FILE__) . '/Api/Rule.php';
    require_once dirname(__FILE__) . '/Api/RuleCondition.php';
    require_once dirname(__FILE__) . '/Api/Shipment.php';
    require_once dirname(__FILE__) . '/Api/Sku.php';
    require_once dirname(__FILE__) . '/Api/SkuOption.php';
    require_once dirname(__FILE__) . '/Api/Video.php';
}
...
class Bigcommerce_Api
{
    ...
    private static $api_path = '/api/v2';
